...
<html lang="en">
	<head>
		...
		?>
		<!-- Bootstrap CSS -->
		<title>Anil Sahasrabudhe | About</title>
	</head>
	<body>
			<?php
        ...
        <div class="container">
            <div class="row">
                <div class="board">
                    ...
                    <div class="liner"></div>
                     <li class="active">
                     <a href="#home" data-toggle="tab" title="Childhood">
                      <span class="round-tabs one">
                              <i class="glyphicon glyphicon-user"></i>
                      </span> 
                  </a></li>

                  <li><a href="#profile" data-toggle="tab" title="Graduation">
                 ...
                 <li><a href="#messages" data-toggle="tab" title="bootsnipp goodies">
                     ...
                     <li><a href="#settings" data-toggle="tab" title="Teaching">
                         <span class="round-tabs four">
                              <i class="fa fa-presentation"></i>
                         </span> 
                     </a></li>

                     <li><a href="#doner" data-toggle="tab" title="Hard Working">
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                          ...
                          <h3 class="head text-center">Childhood <span style="color:#f48260;">♥</span></h3>
                          <p class="narrow text-center">
                             From his childhood, he developed the hobbies of climbing trees, wandering and treking in the area of high peaks and the Valleys of Sahyadri, tours all over the India, drawing and painting, clay scluptering, acting, dancing and directing the performing arts.
                          </p>
                          <p class="narrow text-center">
                      ...
                      <div class="tab-pane fade" id="profile">
                          <h3 class="head text-center">Graduation</h3>
                          <p class="narrow text-center">
                             It was miraculous that he joined as a peon and  the next day immediately he began to serve as a teacher.
								He completed his graduation and post graduation from the Pune University as external student upto 1975.
                          </p>
                          <p class="narrow text-center">
                      ...
                      <div class="tab-pane fade" id="messages">
                          <h3 class="head text-center">Ph.D</h3>
                          <p class="narrow text-center">
                      ...
                      <div class="tab-pane fade" id="settings">
                          <h3 class="head text-center">Teacher</h3>
                          <p class="narrow text-center">
...
<h3 class="head text-center">Hard Working:<span style="color:#f48260;">♥</span> </h3>
<p class="narrow text-center">
...
<div>
			<div id="introaction">
				...
				<div id="introaction-core">
					<div class="row">
						<div class="col-sm-12">
					<div class="action-text action-teaser text-center">
						<h3>“BOOKS ARE THE UNIQUELY PORTABLE MAGIC.”</h3>
						<p>
							“A great book should leave you with many experiences. You live several lives while reading.”
						</p>
					</div>
				</div><div class="action-shadow"></div>
				</div>
				</div>
			</div>
			</div>
